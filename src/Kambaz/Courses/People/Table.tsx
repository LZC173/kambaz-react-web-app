    ...
    <tbody>
     <tr><td className="wd-full-name text-nowrap">
      ...
      <tr>
            ...
            <td className="wd-login-id">001515151B</td>
            <td className="wd-section">S102</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2021-10-02</td>
            <td className="wd-total-activity">08:11:47</td>
          </tr>
    <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
            ...
            <td className="wd-login-id">05111162B</td>
            <td className="wd-section">S103</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-11-02</td>
            <td className="wd-total-activity">08:12:47</td>
          </tr>
